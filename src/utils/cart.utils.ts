...
export function addItemWithQuantity(
  ...
  console.log('existingItemIndex', existingItemIndex, items, item, quantity)
...
// use this if there is decrement button
...
// use this if there is delete | remove button
...
export const generateCartState = (items) => {
